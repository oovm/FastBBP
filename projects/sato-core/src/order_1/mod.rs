...
const YOTTA: i64 = 10939058860032000;
...
impl Display for RamanujanL1 {
    fn fmt(&self, f: &mut Formatter<'_>) -> core::fmt::Result {
        write!(
            ...
            self.a, self.b, self.c, self.d, YOTTA, self.e, self.d,
        )
    }
}
...
impl RamanujanL1 {
    ...
    pub const J7: Self = Self { a: 5, b: 15, c: 1, d: 8, e: 63 };
    /// let `j = (1 + sqrt(-7)) / 2, tau = ?, a = ?, b = ?`
    pub const J11: Self = Self { a: 32, b: 2, c: 1, d: 15, e: 154 };
    /// let `j = (1 + sqrt(-11)) / 2`
    pub const J19: Self = Self { a: 96, b: 6, c: 1, d: 75, e: 1026 };
    /// let `j = (1 + sqrt(-19)) / 2`
    pub const J27: Self = Self { a: 160, b: 30, c: 1, d: 279, e: 4554 };
    /// let `j = (1 + sqrt(-43)) / 2`
    pub const J43: Self = Self { a: 640, b: 15, c: 1, d: 789, e: 16254 };
    /// let `j = (1 + sqrt(-67)) / 2`
    pub const J67: Self = Self { a: 1760, b: 330, c: 1, d: 10177, e: 261702 };
    /// let `j = (1 + sqrt(-163)) / 2`
    pub const J163: Self = Self { a: 426880, b: 10005, c: 1, d: 13591409, e: 545140134 };
}
...
impl RamanujanL1 {
    fn binary_split(&self, j: i64, i: i64) -> (IBig, IBig, IBig) {
        if i == j + 1 {
            ...
            let qab = IBig::from(j).pow(3).mul(YOTTA);
